...
public class InstallActivity extends BaseActivity {
    ...
    private void init(){
        ...
        rvTaskList = (RecyclerView)findViewById(R.id.rv_install);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(InstallActivity.this, MainActivityDrawer.class);
    ...
    private void getTaskList(String install) {
