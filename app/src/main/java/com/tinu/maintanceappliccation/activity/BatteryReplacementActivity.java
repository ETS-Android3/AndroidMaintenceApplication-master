...
public class BatteryReplacementActivity extends BaseActivity {
    ImageView iv_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_battery_replacement);
    ...
    private void init(){
        ...
        rvTaskList = (RecyclerView)findViewById(R.id.rv_battery);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(BatteryReplacementActivity.this, MainActivityDrawer.class);
        ...
        getTaskList("btry_replacement");

    }

    private void getTaskList(String btry_replacement) {
        ...
        Map<String, Object> candidateMap = new HashMap<>();
            ...
            candidateMap.put("type",btry_replacement);
                    ...
                    if (status == true && response.body().getData() != null) {
                        ...
                        taskListRecyclerViewAdapter = new TaskListRecyclerViewAdapter(ApplicationClass.getCurrentContext(), taskListModelList, new TaskListRecyclerViewAdapter.CustomOnClickListener() {
                            ...
                            public void OrderDetails(TaskListModel.Data taskListModel) {
                                ...
                                Intent intent = new Intent(BatteryReplacementActivity.this, ScanActivity.class);
