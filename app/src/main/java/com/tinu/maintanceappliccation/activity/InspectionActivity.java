...
public class InspectionActivity extends BaseActivity {
    ...
    private void init(){
        ...
        rvTaskList = (RecyclerView)findViewById(R.id.rv_inspection);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(InspectionActivity.this, MainActivityDrawer.class);
        ...
        getTaskList("inspection work");

    }

    private void getTaskList(String inspection) {
        ...
        Map<String, Object> candidateMap = new HashMap<>();
            ...
            candidateMap.put("type",inspection);
                    ...
                    if (status == true && response.body().getData() != null) {
                        ...
                        taskListRecyclerViewAdapter = new TaskListRecyclerViewAdapter(ApplicationClass.getCurrentContext(), taskListModelList, new TaskListRecyclerViewAdapter.CustomOnClickListener() {
                            ...
                            public void OrderDetails(TaskListModel.Data taskListModel) {
                                ...
                                Intent intent = new Intent(InspectionActivity.this, ScanActivity.class);
